...
namespace DoctrineORMModule\Proxy\__CG__\Zf2Acl\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Role extends \Zf2Acl\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Zf2Acl\\Entity\\Role' . "\0" . 'id', '' . "\0" . 'Zf2Acl\\Entity\\Role' . "\0" . 'name', '' . "\0" . 'Zf2Acl\\Entity\\Role' . "\0" . 'layout', '' . "\0" . 'Zf2Acl\\Entity\\Role' . "\0" . 'redirect', '' . "\0" . 'Zf2Acl\\Entity\\Role' . "\0" . 'developer', '' . "\0" . 'Zf2Acl\\Entity\\Role' . "\0" . 'created', '' . "\0" . 'Zf2Acl\\Entity\\Role' . "\0" . 'updated', '' . "\0" . 'Zf2Acl\\Entity\\Role' . "\0" . 'parent');
        }
